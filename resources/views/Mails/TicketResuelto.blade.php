                    ...
                    <tr>
                        <td class="content-wrap">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        Se ha Comentado el Ticket N° {{$id_solicitud}} <b></b>, Entregando la solucion de la solicitud, con el siguiente detalle.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <b>Comentario: {{$descripcionSeguimiento}}</b> 
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <b>Quedando a la espera de la confirmacion de finalizacion de su ticket.</b> 
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
