            ...
            timelineData: [
                {
                    ...
                    title: "Inicio",
                    desc:
                        "Encontrarás el acceso a la pantalla de Inicio, el listado de tickets solicitados"
                },
                {
                    color: "primary",
                    icon: "TvIcon",
                    ...
                    desc:
                        "En esta sección podrás visualizar la informacion de tus solicitudes"
                },
                {
                    color: "success",
                    icon: "LayoutIcon",
                    ...
                    desc:
                        "En esta seccion generaras los tickets a la Unidad de Informatica"
                }
            ],
            resetI: 0,
            supportTracker: {},
