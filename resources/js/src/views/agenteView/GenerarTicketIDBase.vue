        ...
        cargarDataByID() {
            try {
                ...
                axios
                    ...
                    .then(res => {
                        this.listadoTicketByID = res.data;
                        let b = [];
                        let c = JSON.parse(
                            JSON.stringify(this.listadoTicketByID)
                        );
                        c.forEach((value, index) => {
                            b.push(value);
                        });
                        ...
                        idGeneral = this.listadoTicketByID[0].id_supervisor;
                        b = [];
                        a = 0;
                        c.forEach((value, index) => {
                            a = value.id;
                        ...
                        idGeneral = this.listadoTicketByID[0].id_trabajador;
                        b = [];
                        a = 0;
                        c.forEach((value, index) => {
                            a = value.id;
                        ...
                        idGeneral = this.listadoTicketByID[0].idApoyo1;
                        b = [];
                        a = 0;
                        c.forEach((value, index) => {
                            a = value.id;
                        ...
                        idGeneral = this.listadoTicketByID[0].idApoyo2;
                        b = [];
                        a = 0;
                        c.forEach((value, index) => {
                            a = value.id;
                        ...
                        idGeneral = this.listadoTicketByID[0].idApoyo3;
                        b = [];
                        a = 0;
                        c.forEach((value, index) => {
                            a = value.id;
