            ...
            <div class="flex mb-4">
                <div class="w-full m-2">
                    <vs-input
                        ...
                        v-model="descripcion_ctelefonicas"
                    ></vs-input>
                </div>
            </div>
            <div class="flex mb-4">
    ...
    data() {
        return {
            ...
            events: {
                ...
                id_reemplazo: null,
                id_turno_extra: null,
                id_calendario_ctelefonicas: null,
                classes: "",
                estado_turno_extra: true,
                estado_reemplazo: true,
                estado_dia_administrativo: true,
    ...
    methods: {
        ...
        infoDetallada() {
            ...
            listadoInfo.forEach((value, index) => {
                if (value.id == this.id_calendario_ctelefonicas) {
                    a.push(value);
                }
            });
            this.listadoInf = a;
        ...
        addEvent() {
            try {
                if (this.title == "" || this.title.length < 5) {
                    ...
                    this.descripcion_ctelefonicas == "" ||
                    this.descripcion_ctelefonicas.length < 5
                ) {
                    this.$vs.notify({
                        time: 3000,
                        title: "Error",
                    ...
                    this.events.descripcion_ctelefonicas = this.descripcion_ctelefonicas;
        ...
        clearFields() {
            ...
            this.id_calendario_ctelefonicas = 0;
        ...
        openEditEvent(event) {
            try {
                ...
                const e = b;
                this.id_calendario_ctelefonicas = e[0].id;
                this.title = e[0].title;
                this.startDate = e[0].startDate;
                this.endDate = e[0].endDate;
                this.descripcion_ctelefonicas = e[0].descripcion_ctelefonicas;
                ...
                if (e[0].id_val_dia_administrativo == 1) {
                    ...
                    dataDiaAdm.forEach((value, index) => {
                        bb = value.id_calendario_ctelefonicas;
                        if (bb == e[0].id) {
                            aa.push(value);
                        }
                    });
                ...
                if (e[0].id_val_vacaciones == 1) {
                    ...
                    dataVacaciones.forEach((value, index) => {
                        b = value.id_calendario_ctelefonicas;
                        if (b == e[0].id) {
                            a.push(value);
                        }
                    });
                ...
                if (this.title == "" || this.title.length < 5) {
                    ...
                    if (count != 1) {
                        const events = {
                            ...
                            id_calendario_ctelefonicas: this
                                .id_calendario_ctelefonicas,
