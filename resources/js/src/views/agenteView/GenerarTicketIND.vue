...
export default {
    ...
    methods: {
        ...
        arrayTipoReparacion(id) {
            ...
            this.seleccionReparacion.id = b[0].id;
            this.seleccionReparacion.descripcionTipoReparacion =
                b[0].descripcionTipoReparacion;
        },
