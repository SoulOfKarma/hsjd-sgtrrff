    ...
    methods: {
        ...
        finalizarTicket() {
            try {
                ...
                axios
                    .post(
                        this.localVal + "/api/Agente/PostCierreTicketAP",
                        data,
                        {
                            headers: {
                                Authorization:
        ...
        cargarSolicitudes() {
            axios
                .get(this.localVal + "/api/Agente/GetSolicitudTicketsCAH", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        asignarSolicitud(id, uuid) {
            ...
            axios
                .get(
                    this.localVal + `/api/Agente/ValidarTicketAsignadoAP/${id}`,
                    {
                        headers: {
                            Authorization:
                                `Bearer ` + sessionStorage.getItem("token")
        ...
        eliminarSolicitud(id, uuid, eliminar) {
            if (eliminar) {
                if (
                    ...
                    axios
                        .post(
                            this.localVal + "/api/Agente/destroyTicketAP",
                            dataEliminacion,
                            {
                                headers: {
                                    Authorization:
