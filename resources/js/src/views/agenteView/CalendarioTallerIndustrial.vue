        ...
        <vue-easy-print tableShow ref="easyPrint">
            <div class="vx-card no-scroll-content" id="prin">
                <calendar-view
                    ...
                    :show-date="showDate"
                    :events="listadoCalendariotindustrial"
            ...
            <div class="flex mb-4">
                <div class="w-full m-2">
                    <vs-input
                        ...
                        v-model="descripcion_tindustrial"
                    ></vs-input>
                </div>
            </div>
            <div class="flex mb-4">
                    ...
                    <vs-table max-items="3" pagination :data="listadoInf">
                        ...
                        <template slot-scope="{ data }">
                            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                                ...
                                <vs-td
                                    :data="
                                        data[indextr].descripcion_tindustrial
                                    "
                                >
                                    {{ data[indextr].descripcion_tindustrial }}
                                </vs-td>
    ...
    methods: {
        ...
        verInfo(idDAdm, idVac, idRem, idTExt) {
            if (idDAdm == 1 || idVac == 1 || idRem == 1 || idTExt == 1) {
                ...
                axios
                    .post(
                        this.localVal + "/api/Agente/GetDataCalenTIndustrial",
                        dat,
                        {
                            headers: {
                                Authorization:
        ...
        infoDetallada() {
            let listadoInfo = this.listadoCalendariotindustrial;
            let a = [];
            listadoInfo.forEach((value, index) => {
                if (value.id == this.id_taller_industrial) {
                    a.push(value);
                }
            });
            this.listadoInf = a;
        ...
        simpleCalendarEvents() {
            axios
                .get(this.localVal + "/api/Agente/GetCalendarioTIndustrial", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
                ...
                .then(res => {
                    this.listadoCalendariotindustrial = res.data;
                })
                .catch(error => {
                    if (error.response.status === 401) {
                        this.$vs.notify({
        ...
        cargaDAdminOxi() {
            axios
                .get(this.localVal + "/api/Agente/DAdminTIndustrial", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaVacOxi() {
            axios
                .get(this.localVal + "/api/Agente/VTIndustrial", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaRemOxi() {
            axios
                .get(this.localVal + "/api/Agente/RTIndustrial", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaTurExtOxi() {
            axios
                .get(this.localVal + "/api/Agente/TurExtTIndustrial", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        addEvent() {
            try {
                if (this.title == "" || this.title.length < 5) {
                    ...
                    this.descripcion_tindustrial == "" ||
                    this.descripcion_tindustrial.length < 5
                ) {
                    this.$vs.notify({
                        time: 3000,
                        title: "Error",
                    ...
                    this.events.descripcion_tindustrial = this.descripcion_tindustrial;
                    ...
                    axios
                        .post(
                            this.localVal +
                                "/api/Agente/PostCalendarioTIndustrial",
                            newevent,
                            {
                                headers: {
                                    Authorization:
        ...
        openEditEvent(event) {
            try {
                let calen = this.listadoCalendariotindustrial;
                let b = [];
                let a = 0;
                ...
                const e = b;
                this.id_taller_industrial = e[0].id;
                this.title = e[0].title;
                this.startDate = e[0].startDate;
                this.endDate = e[0].endDate;
                this.descripcion_tindustrial = e[0].descripcion_tindustrial;
                ...
                if (this.title == "" || this.title.length < 5) {
                    ...
                    if (count != 1) {
                        const events = {
                            ...
                            id_taller_industrial: this.id_taller_industrial,
                        ...
                        axios
                            .post(
                                this.localVal +
                                    "/api/Agente/PutCalendarioTIndustrial",
                                events,
                                {
                                    headers: {
                                        Authorization:
