        ...
        <vue-easy-print tableShow ref="easyPrint">
            <div class="vx-card no-scroll-content" id="prin">
                <calendar-view
                    ...
                    :show-date="showDate"
                    :events="listadoCalendarioGasfiter"
                    ...
                    <vs-table max-items="3" pagination :data="listadoInf">
                        ...
                        <template slot-scope="{ data }">
                            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                                ...
                                <vs-td
                                    :data="data[indextr].descripcion_gasfiters"
                                >
                                    {{ data[indextr].descripcion_gasfiters }}
                                </vs-td>
    ...
    methods: {
        ...
        verInfo(idDAdm, idVac, idRem, idTExt) {
            if (idDAdm == 1 || idVac == 1 || idRem == 1 || idTExt == 1) {
                ...
                const dat = data;
                axios
                    .post(this.localVal + "/api/Agente/GetDataCalenGasf", dat, {
                        headers: {
                            Authorization:
        ...
        infoDetallada() {
            let listadoInfo = this.listadoCalendarioGasfiter;
            let a = [];
            listadoInfo.forEach((value, index) => {
                if (value.id == this.id_calendario_gasfiter) {
                    a.push(value);
                }
            });
            this.listadoInf = a;
        ...
        simpleCalendarEvents() {
            axios
                .get(this.localVal + "/api/Agente/GetCalendarioGasf", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
                ...
                .then(res => {
                    this.listadoCalendarioGasfiter = res.data;
                });
        },
        ...
        cargaDAdminGasf() {
            axios
                .get(this.localVal + "/api/Agente/DAdminGasfiters", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaVacGasf() {
            axios
                .get(this.localVal + "/api/Agente/VGasfiters", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaRemGasf() {
            axios
                .get(this.localVal + "/api/Agente/RGasfiters", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaTurExtGasf() {
            axios
                .get(this.localVal + "/api/Agente/TurExtGasfiters", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        addEvent() {
            try {
                if (this.title == "" || this.title.length < 5) {
                    ...
                    this.descripcion_gasfiters == "" ||
                    this.descripcion_gasfiters.length < 5
                ) {
                    this.$vs.notify({
                        time: 3000,
                        title: "Error",
                    ...
                    this.events.descripcion_gasfiters = this.descripcion_gasfiters;
                    ...
                    axios
                        .post(
                            this.localVal + "/api/Agente/PostCalendarioGasf",
                            newevent,
                            {
                                headers: {
                                    Authorization:
        ...
        openEditEvent(event) {
            try {
                let calen = this.listadoCalendarioGasfiter;
                let b = [];
                let a = 0;
                ...
                const e = b;
                this.id_calendario_gasfiter = e[0].id;
                this.title = e[0].title;
                this.startDate = e[0].startDate;
                this.endDate = e[0].endDate;
                this.descripcion_gasfiters = e[0].descripcion_gasfiters;
                ...
                if (e[0].id_val_dia_administrativo == 1) {
                    ...
                    dataDiaAdm.forEach((value, index) => {
                        bb = value.id_calendario_gasfiter;
                        if (bb == e[0].id) {
                            aa.push(value);
                        }
                    });
                ...
                if (e[0].id_val_vacaciones == 1) {
                    ...
                    dataVacaciones.forEach((value, index) => {
                        b = value.id_calendario_gasfiter;
                        if (b == e[0].id) {
                            a.push(value);
                        }
                    });
                ...
                if (this.title == "" || this.title.length < 5) {
                    ...
                    if (count != 1) {
                        const events = {
                            ...
                            descripcion_gasfiters: this.descripcion_gasfiters,
                            ...
                            id_calendario_gasfiter: this.id_calendario_gasfiter,
                        ...
                        axios
                            .post(
                                this.localVal + "/api/Agente/PutCalendarioGasf",
                                events,
                                {
                                    headers: {
                                        Authorization:
