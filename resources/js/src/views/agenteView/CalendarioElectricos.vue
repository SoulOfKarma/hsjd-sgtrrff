            ...
            <div class="flex mb-4">
                <div class="w-full m-2">
                    <vs-input
                        ...
                        v-model="descripcion_electricos"
                    ></vs-input>
                </div>
            </div>
            <div class="flex mb-4">
                    ...
                    <vs-table max-items="3" pagination :data="listadoInf">
                        ...
                        <template slot-scope="{ data }">
                            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                                ...
                                <vs-td
                                    :data="data[indextr].descripcion_electricos"
                                >
                                    {{ data[indextr].descripcion_electricos }}
                                </vs-td>
    ...
    methods: {
        ...
        verInfo(idDAdm, idVac, idRem, idTExt) {
            if (idDAdm == 1 || idVac == 1 || idRem == 1 || idTExt == 1) {
                ...
                const dat = data;
                axios
                    .post(this.localVal + "/api/Agente/GetDataCalenElec", dat, {
                        headers: {
                            Authorization:
        ...
        infoDetallada() {
            let listadoInfo = this.listadoCalendarioElec;
            let a = [];
            listadoInfo.forEach((value, index) => {
                if (value.id == this.id_calendario_electricos) {
                    a.push(value);
                }
            });
            this.listadoInf = a;
        ...
        simpleCalendarEvents() {
            axios
                .get(this.localVal + "/api/Agente/GetCalendarioElec", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
                ...
                .then(res => {
                    this.listadoCalendarioElec = res.data;
                })
                .catch(error => {
                    if (error.response.status === 401) {
                        this.$vs.notify({
        ...
        cargaDAdminElec() {
            axios
                .get(this.localVal + "/api/Agente/DAdminElec", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaVacElec() {
            axios
                .get(this.localVal + "/api/Agente/VElectricos", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaRemElec() {
            axios
                .get(this.localVal + "/api/Agente/RElectricos", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        cargaTurExtElec() {
            axios
                .get(this.localVal + "/api/Agente/TurExtElectricos", {
                    headers: {
                        Authorization:
                            `Bearer ` + sessionStorage.getItem("token")
                    }
        ...
        addEvent() {
            try {
                if (this.title == "" || this.title.length < 5) {
                    ...
                    this.descripcion_electricos == "" ||
                    this.descripcion_electricos.length < 5
                ) {
                    this.$vs.notify({
                        time: 3000,
                        title: "Error",
                    ...
                    this.events.descripcion_electricos = this.descripcion_electricos;
                    ...
                    axios
                        .post(
                            this.localVal + "/api/Agente/PostCalendarioElec",
                            newevent,
                            {
                                headers: {
                                    Authorization:
        ...
        clearFields() {
            ...
            this.id_calendario_electricos = 0;
        ...
        openEditEvent(event) {
            try {
                let calen = this.listadoCalendarioElec;
                let b = [];
                let a = 0;
                ...
                const e = b;
                this.id_calendario_electricos = e[0].id;
                this.title = e[0].title;
                this.startDate = e[0].startDate;
                this.endDate = e[0].endDate;
                this.descripcion_electricos = e[0].descripcion_electricos;
                ...
                if (e[0].id_val_dia_administrativo == 1) {
                    ...
                    dataDiaAdm.forEach((value, index) => {
                        bb = value.id_calendario_electricos;
                        if (bb == e[0].id) {
                            aa.push(value);
                        }
                    });
                ...
                if (e[0].id_val_vacaciones == 1) {
                    ...
                    dataVacaciones.forEach((value, index) => {
                        b = value.id_calendario_electricos;
                        if (b == e[0].id) {
                            a.push(value);
                        }
                    });
                ...
                if (this.title == "" || this.title.length < 5) {
                    ...
                    if (count != 1) {
                        const events = {
                            ...
                            descripcion_electricos: this.descripcion_electricos,
                            ...
                            id_calendario_electricos: this
                                .id_calendario_electricos,
                        ...
                        axios
                            .post(
                                this.localVal + "/api/Agente/PutCalendarioElec",
                                events,
                                {
                                    headers: {
                                        Authorization:
