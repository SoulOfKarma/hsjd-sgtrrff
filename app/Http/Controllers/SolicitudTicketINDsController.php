...
class SolicitudTicketINDsController extends Controller
{
    ...
    public function getTicketsKPITotal(){
        try {
            ...
            DB::raw("(SELECT COUNT(solicitud_ticket_i_n_ds.id_estado) FROM solicitud_ticket_i_n_ds WHERE solicitud_ticket_i_n_ds.id_estado BETWEEN 5 AND 9) AS FinalTicket"),
            DB::raw("ROUND(((SELECT COUNT(id_estado) FROM solicitud_ticket_i_n_ds WHERE id_estado BETWEEN 5 AND 9)*100)/(SELECT COUNT(id_estado) FROM solicitud_ticket_i_n_ds),2) AS Porcentaje"))
    ...
    public function getTicketsKPI(){
        try {
            ...
            DB::raw("(CASE WHEN solicitud_ticket_i_n_ds.id_estado = 1 THEN COUNT(solicitud_ticket_i_n_ds.id_estado)
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 2 AND 4 THEN (select COUNT(solicitud_ticket_i_n_ds.id_estado) from solicitud_ticket_i_n_ds where solicitud_ticket_i_n_ds.id_estado BETWEEN 2 AND 4)
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 5 AND 9 THEN (select COUNT(solicitud_ticket_i_n_ds.id_estado) from solicitud_ticket_i_n_ds where solicitud_ticket_i_n_ds.id_estado BETWEEN 5 AND 9)
                          END) AS counts"),
            DB::raw("(CASE WHEN solicitud_ticket_i_n_ds.id_estado = 1 THEN 'primary'
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 2 AND 4 THEN 'warning'
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 5 AND 9 THEN 'success'
                          END) AS color"),
            DB::raw("(CASE WHEN solicitud_ticket_i_n_ds.id_estado = 1 THEN '#7961F9'
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 2 AND 4 THEN '#FF9F43'
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 5 AND 9 THEN '#1fcd39'
                          END) AS codcolor"),        
            DB::raw("(CASE WHEN solicitud_ticket_i_n_ds.id_estado = 1 THEN '#9c8cfc'
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 2 AND 4 THEN '#FFC085'
                          WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 5 AND 9 THEN '#1fcd39'
                          END) AS gradcolor"),                    
            ...
            WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 2 AND 4 THEN COALESCE(ROUND(((SELECT COUNT(id_estado) FROM solicitud_ticket_i_n_ds WHERE id_estado BETWEEN 2 AND 4)*100)/(SELECT COUNT(id_estado) FROM solicitud_ticket_i_n_ds),1),0)
            WHEN solicitud_ticket_i_n_ds.id_estado BETWEEN 5 AND 9 THEN ROUND(((SELECT COUNT(id_estado) FROM solicitud_ticket_i_n_ds WHERE id_estado BETWEEN 5 AND 9)*100)/(SELECT COUNT(id_estado) FROM solicitud_ticket_i_n_ds),0)
            END) AS porcentaje"))
            ->join('estado_solicituds','solicitud_ticket_i_n_ds.id_estado','=','estado_solicituds.id')
    ...
    public function getNotificaciones(){
        try {
            $get_all = SolicitudTicketINDs::select(DB::raw("fnStripTags(solicitud_ticket_i_n_ds.descripcionP) as msg"),'solicitud_ticket_i_n_ds.id',
