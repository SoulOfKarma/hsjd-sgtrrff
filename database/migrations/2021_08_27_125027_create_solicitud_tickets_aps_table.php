...
class CreateSolicitudTicketsApsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('solicitud_tickets_aps', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid');
    ...
    {
        Schema::dropIfExists('solicitud_tickets_aps');
    }
}
