...
class CreateTurnoExtraElectricosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('turno_extra_electricos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('turno_extra_electricos');
    }
}
