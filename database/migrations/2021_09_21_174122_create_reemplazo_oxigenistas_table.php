...
class CreateReemplazoOxigenistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reemplazo_oxigenistas', function (Blueprint $table) {
            $table->id();  
    ...
    {
        Schema::dropIfExists('reemplazo_oxigenistas');
    }
}
