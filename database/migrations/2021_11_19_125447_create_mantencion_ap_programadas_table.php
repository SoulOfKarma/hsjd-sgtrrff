...
class CreateMantencionApProgramadasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mantencion_ap_programadas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mantencion_ap_programadas');
    }
}
