...
class CreateCalendarioTallerIndustrialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if ( !Schema::hasTable('calendario_taller_industrials') ) {
        Schema::create('calendario_taller_industrials', function (Blueprint $table) {
            $table->id();
            $table->string('title');
            $table->string('descripcion_tindustrial');
    ...
    {
        Schema::dropIfExists('calendario_taller_industrials');
    }
}
