...
class CreateCalendarioCalderasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('calendario_calderas', function (Blueprint $table) {
            $table->id();
            $table->string('title');
            $table->string('descripcion_calderas');
    ...
    {
        Schema::dropIfExists('calendario_calderas');
    }
}
