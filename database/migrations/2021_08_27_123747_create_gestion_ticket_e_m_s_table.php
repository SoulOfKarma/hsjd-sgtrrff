...
class CreateGestionTicketEMSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gestion_ticket_e_m_s', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid');
    ...
    {
        Schema::dropIfExists('gestion_ticket_e_m_s');
    }
}
