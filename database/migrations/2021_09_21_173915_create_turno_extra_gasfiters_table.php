...
class CreateTurnoExtraGasfitersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('turno_extra_gasfiters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('turno_extra_gasfiters');
    }
}
