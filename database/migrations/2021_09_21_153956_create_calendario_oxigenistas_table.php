...
class CreateCalendarioOxigenistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('calendario_oxigenistas', function (Blueprint $table) {
            $table->id();
            $table->string('title');
            $table->string('descripcion_oxigenistas');
    ...
    {
        Schema::dropIfExists('calendario_oxigenistas');
    }
}
